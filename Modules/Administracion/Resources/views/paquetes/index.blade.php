            ...
            <div class="col-sm-6 col-md-4 my-3 ">
                <div class="card  border-success bg-github h-100" style="border:solid 1px #0e9f6e">
                    ...
                    <div class="card-body">
                        ...
                        <h3 class="card-title text-primary text-uppercase text-center">$ {{$paquete->precio_venta+($paquete->precio_venta*($paquete->iva/100))}}</h3>
                    ...
                    <div class="card-body d-flex justify-content-center">
                        <a href="{{route('paquete.edit',$paquete->id)}}" class="card-link"> <i class="fa fa-edit text-warning mr-2"></i>Editar</a>
