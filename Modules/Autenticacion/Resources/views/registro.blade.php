                ...
                <div class="row">
                    <div class="col-md-4  shadow">
                        ...
                        <div class="card-body">
                            <div class="form-group">
                                <label>Nombre</label>
                                <input type="text" class="form-control border-primary  @error('nombre') is-invalid @enderror" name="nombre">
                                @error('nombre')
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control border-primary @error('apellido') is-invalid @enderror" name="apellido">
                                @error('apellido')
                                <small class="text-danger">{{$message}}</small>
                                @enderror
                            </div>
                            <div class="form-group">
                                ...
                                <input type="number" class="form-control border-primary @error('identificacion') is-invalid @enderror" name="identificacion">
                            ...
                            <div class="form-group">
                                ...
                                <input type="date" class="form-control border-primary @error('fecha_nacimiento') is-invalid @enderror" name="fecha_nacimiento">
                            ...
                            <div class="form-group">
                                ...
                                <input type="number" class="form-control border-primary @error('numero_telefonico') is-invalid @enderror" name="numero_telefonico">
                    ...
                    <div class="col-md-4  shadow">
                        ...
                        <div class="card-body">
                            <div class="form-group">
                                <label>E-Mail</label>
                                <input type="email" class="form-control border-primary @error('email') is-invalid @enderror" name="email">
                                @error('email')
                                <small class="text-danger">{{$message}}</small>
                                @enderror
                            </div>
                            <div class="form-group">
                                <label>Usuario</label>
                                <input type="text" class="form-control border-primary @error('usuario') is-invalid @enderror" name="usuario">
                                @error('usuario')
                                <small class="text-danger">{{$message}}</small>
                                @enderror
                            </div>
                            <div class="form-group">
                                ...
                                <input type="password" class="form-control border-primary @error('contraseña') is-invalid @enderror" name="contraseña">
                                @error('contraseña')
                                <small class="text-danger">{{$message}}</small>
                                @enderror
                            </div>
                            <div class="form-group">
                                ...
                                <input type="password" class="form-control border-primary " name="contraseña_confirmation">
