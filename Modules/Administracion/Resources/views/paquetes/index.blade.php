        ...
        @foreach($listaPaquetes as $paquete)
            <div class="col-sm-6 col-md-4 my-3 ">
                <div class="card shadow border-primary">
                    ...
                    <div class="card-body">
                        <h3 class="card-title text-success text-uppercase text-center">{{$paquete->nombre}}</h3>
                        <h3 class="card-title text-success text-uppercase text-center">$ {{$paquete->precio_venta}}</h3>
                        <ul class="list-group list-group-flush bg-dark">
                            <li class="list-group-item "><i class="fa fa-star text-warning"></i> IVA : {{$paquete->iva}}%</li>
